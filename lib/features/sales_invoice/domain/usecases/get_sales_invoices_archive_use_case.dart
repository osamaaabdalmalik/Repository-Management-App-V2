...
class GetSalesInvoicesArchiveUseCase {
  final SalesInvoiceRepo repo;

  GetSalesInvoicesArchiveUseCase(this.repo);

  Future<Either<Failure, List<SalesInvoice>>> call({required int id}) async {
    Get.find<Logger>().i("Call GetSalesInvoicesArchiveUseCase");
    return await repo.getSalesInvoicesArchive(repositoryId: id);
  }
}
